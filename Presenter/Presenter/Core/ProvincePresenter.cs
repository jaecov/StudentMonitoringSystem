...
{
    public class ProvincePresenter : BasePresenter<IProvince>
    {
        #region Constructor

        public ProvincePresenter(IProvince view)
        {
            View = view;
        }
        ...
        public void LoadProvinceInfo(int id)
        {
            var item = Controller.GetObjectItemByColumnID<core_province>(id);
            if (item == null)
                return;
        ...
        public bool Delete()
        {
            ...
            try
            {
                var item = Controller.GetObjectItemByColumnID<core_province>(View.ID);
                if (item == null)
                    return false;

                Controller.DeleteObject<core_province>(item);
                LoadItems();
        ...
        private void CreateProvince()
        {
            try
            {
                ...
                var item = new core_province();
                item.name = View.Name;

                var result = Controller.CreateObject<core_province>(item);
                View.ID = result.id;
        ...
        private void UpdateProvince()
        {
            try
            {
                ...
                Controller.UpdateObject<core_province>(item);
