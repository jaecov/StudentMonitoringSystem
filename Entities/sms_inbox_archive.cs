...
{
    [Serializable]
    public partial class sms_inbox_archive: BaseObject
    {
        #region Primitive Properties
    
        public  int archivedid
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.sms_inbox_archive.Contains(this))
            {
                previousValue.sms_inbox_archive.Remove(this);
            }
    
            if (sms_status != null)
            {
                if (!sms_status.sms_inbox_archive.Contains(this))
                {
                    sms_status.sms_inbox_archive.Add(this);
                }
