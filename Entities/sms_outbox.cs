...
{
    [Serializable]
    public partial class sms_outbox: BaseObject
    {
        ...
        {
            if (previousValue != null && previousValue.sms_outbox.Contains(this))
            {
                previousValue.sms_outbox.Remove(this);
            }
    
            if (sms_status != null)
            {
                if (!sms_status.sms_outbox.Contains(this))
                {
                    sms_status.sms_outbox.Add(this);
                }
